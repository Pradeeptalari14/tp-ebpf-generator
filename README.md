# 🐝 eBPF Tracing Generator
> Generate eBPF C program filters and Python/Go loader scripts. Monitor kprobes and tracepoints, and view live tracing logs output simulations.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/ebpf-generator/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/ebpf-generator/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-ebpf-generator.git
cd tp-ebpf-generator
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/ebpf-generator/) |
